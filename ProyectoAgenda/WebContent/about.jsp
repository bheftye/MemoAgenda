...
<div class="page">
  <div class="about-page">
    <div class="sidebar"> <a href="`portal.jsp" id="logo"><img src="images/logo.png" alt="logo"></a>
      <ul>
      ...
      <div class="connect"> <a href="http://freewebsitetemplates.com/go/facebook/" id="fb">facebook</a> <a href="http://freewebsitetemplates.com/go/twitter/" id="twitter">twitter</a> </div>
    </div>
    <div class="body">
      <div class="login">
      				Bienvenido <s:property value="#session['usuario'].alias" /> | 					
					
					<s:a href="index.jsp" onClick="cerrarSesion">Cerrar sesión</s:a></div>
      <div class="content-about">
        ...
        <div>
          <div>
            ...
            <br />
             <p> <strong>Nombre:</strong> <s:property value="#session['usuario'].nombre"/>
